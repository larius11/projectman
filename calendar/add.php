                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title">
                                    <i class="fa fa-fw fa-pencil-square-o"></i>Add Event Form
                                </h3>
                            </div>
                                ...
                                <form action="../php/add_process.php" method="POST">
                                    <div class="col-lg-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="datetime-local" step="900" class="form-control" id="start" name="start">
                                        </div>
                                        <div class="form-group">
                                            <label>End Time:</label>
                                            <input type="datetime-local" step="900" class="form-control" id="end" name="end">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label>Description:</label>
                                            <textarea type="text" class="form-control" rows="12" id="url" name="url" style="resize: none;"></textarea>
                                        </div>
                                        <button type="submit" class="btn btn-primary btn-lg" value="Submit" style="float: right;">Add</button>
                                    </div>
                                </form>
                            </div>
                        </div>
