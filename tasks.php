    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="jumbotron">
                    <h1>Hello, Ricardo!</h1>
                    <p>This is a template for how your tasks will look, they will be interactive and display necessary files and materials for completion. As well as milestones to display progress.</p>
                ...
                <div class="form-group">
                    <label>Tasks left</label>
                        <div class="checkbox">
                            <label>
                                <input type="checkbox" value="">Damages
                            </label>
                        </div>
                        <div class="checkbox">
                            <label>
                                <input type="checkbox" value="">Clean Checkstands
                            </label>
                        </div>
                        <div class="checkbox">
                            <label>
                                <input type="checkbox" value="">Parking Lot Clear
                            </label>
                        </div>
                        <div class="checkbox">
                            <label>
                                <input type="checkbox" value="">Bags and Coupons Refilled
                            </label>
                        </div>
                        <button type="submit" class="btn btn-default">Submit</button>
                </div>
                <h2>Transfer Supply</h2>
                <div class="progress">
